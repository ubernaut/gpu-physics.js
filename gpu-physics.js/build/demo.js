(function (global, factory) {
	...
	function Demo(parameters){
	    ...
	    function init(){
	        ...
	        // interaction
	        interactionSphereMesh = new THREE__namespace.Mesh(new THREE__namespace.SphereBufferGeometry(1,32,32), new THREE__namespace.MeshPhongMaterial({ color: 0xffffff }));
